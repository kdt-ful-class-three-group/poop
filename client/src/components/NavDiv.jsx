...
function NavDiv({ navRef, btnClick, closeNav }) {
  ...
  return (
    <div
      ...
      className={`bg-gray-200 absolute flex-col items-center bottom-0 justify-center gap-20 p-4 w-full rounded-t-full h-[230px] max-w-[450px] max-h-[450px] transition-all duration-300 ease-in-out ${btnClick ? "flex opacity-100 pointer-events-auto" : "flex pointer-events-none opacity-0"
        }`}
    >
      <div className="flex">
